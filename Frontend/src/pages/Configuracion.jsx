...
import { Search, Bell, User, Headphones, Settings, Shield, Globe, Trash2, RefreshCw, Eye, EyeOff } from "lucide-react";
        ...
        <main className="home-content">
          ...
          <section className="configuracion-section">
            ...
            <div className="config-grid">
              ...
              <ConfigCard titulo="Notificaciones" icon={Bell} estadoTexto="Activado" estadoColor="#00ff00" btnTexto="Desactivar" />
            </div>
        ...
        <div style={{ position:"fixed", top:0, left:0, width:"100vw", height:"100vh", background:"rgba(0,0,0,0.7)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:1000 }}>
          <div style={{ background:"#0d0d1a", border:"1px solid #00ffff", borderRadius:"12px", padding:"2rem", minWidth:"340px", display:"flex", flexDirection:"column", gap:"0.75rem" }}>
            ...
            <input
              ...
              style={{ background:"#1a1a2e", border:"1px solid #333", borderRadius:"8px", padding:"0.7rem 1rem", color:"#fff", width:"100%", fontSize:"0.95rem", boxSizing:"border-box" }}
            />
            ...
            <div style={{ position:"relative", width:"100%" }}>
              <input
                ...
                style={{ background:"#1a1a2e", border:"1px solid #333", borderRadius:"8px", padding:"0.7rem 2.8rem 0.7rem 1rem", color:"#fff", width:"100%", fontSize:"0.95rem", boxSizing:"border-box" }}
              />
